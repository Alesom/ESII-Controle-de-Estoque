<?php
	...
	if(isset($_POST['cadprod'])){
		...
		$sql = "INSERT INTO produto VALUES ('$cod','$nome','$qtdade','$codgrupo','$codlocal')";
...
<body onload="opera();">
	<div id="cadp" align="center">
		...
		<form action="produto.php?cadp=1" method="post">	
			...
			<input type="text" name="codlocal" placeholder="Código do local" /><br/>
